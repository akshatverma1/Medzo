      ...
      <section className="column">
        ...
        <div className="container-narrow py-24">
          ...
          <div className="flex justify-between items-start mb-8">
            <div>
              <h1 className="h2">Welcome back, Dr. {doctor?.firstName || 'Doctor'}</h1>
          ...
          {activeTab === 'overview' && (
            <>
              {/* Doctor Metrics */}
              <div className="grid-4 mt-8 gap-6">
              ...
              <div className="grid-2 mt-8 gap-8">
                ...
                <div className="card p-6">
                  <div className="flex justify-between items-center mb-6">
                    <h2 className="h4 text-gray-800">Today's Schedule</h2>
                    <span className="badge badge-primary">{appointments.today?.length || 0} appointments</span>
                  </div>
                  <div className="space-y-4">
                    {appointments.today?.map(appt => (
                      <div key={appt.id} className="flex items-center justify-between p-4 border rounded-lg hover:bg-gray-50">
              ...
              <div className="grid-2 mt-8 gap-8">
                {/* Patient Statistics */}
                <div className="card p-6">
                  <h2 className="h4 text-gray-800 mb-6">Patient Statistics</h2>
                  <Charts.BarAppointments />
                </div>

                {/* Treatment Distribution */}
                <div className="card p-6">
                  <h2 className="h4 text-gray-800 mb-6">Treatment Distribution</h2>
          ...
          {activeTab === 'patients' && (
            <div className="mt-8">
              <div className="flex justify-between items-center mb-6">
                <h2 className="h3 text-gray-800">My Patients</h2>
              ...
              <div className="grid gap-6">
                {patients.map(patient => (
                  <div key={patient._id} className="card p-6 hover:shadow-lg transition-shadow">
          ...
          {activeTab === 'appointments' && (
            <div className="mt-8">
              <div className="grid-2 gap-8">
                ...
                <div className="card p-6">
                  <h2 className="h4 text-gray-800 mb-6">Today's Appointments</h2>
                  <div className="space-y-4">
                    {appointments.today?.map(appt => (
                      <div key={appt.id} className="p-4 border rounded-lg hover:bg-gray-50">
                        ...
                        <div className="flex space-x-2 mt-3">
                          ...
                          <button className="btn btn-sm btn-primary flex-1">Start Consultation</button>
                        </div>
                      </div>
                    ))}
                  </div>
                ...
                <div className="card p-6">
                  <h2 className="h4 text-gray-800 mb-6">Upcoming Appointments</h2>
                  <div className="space-y-4">
          ...
          {activeTab === 'reports' && (
            <div className="mt-8">
              <div className="grid-2 gap-8">
                <div className="card p-6">
                  <h2 className="h4 text-gray-800 mb-6">Monthly Performance</h2>
                  <Charts.BarAppointments />
                </div>
                <div className="card p-6">
                  <h2 className="h4 text-gray-800 mb-6">Patient Demographics</h2>
                  <Charts.PieTreatments />
                </div>
              </div>
              
              <div className="card p-6 mt-8">
                <h2 className="h4 text-gray-800 mb-6">Recent Medical Reports</h2>
                <div className="space-y-4">
                  {patients.slice(0, 5).map(patient => (
                    <div key={patient._id} className="flex justify-between items-center p-4 border rounded-lg">
                      <div>
